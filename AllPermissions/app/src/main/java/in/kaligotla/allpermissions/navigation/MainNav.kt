...
import `in`.kaligotla.allpermissions.presentation.about.AboutScreen
import `in`.kaligotla.allpermissions.presentation.main.home.myHome.MyHome
import `in`.kaligotla.allpermissions.presentation.main.permissions.bodySensors.MyBodySensors
import `in`.kaligotla.allpermissions.presentation.main.permissions.calendar.MyCalendar
import `in`.kaligotla.allpermissions.presentation.main.permissions.callLogs.MyCallLogs
import `in`.kaligotla.allpermissions.presentation.main.permissions.camera.MyCamera
import `in`.kaligotla.allpermissions.presentation.main.permissions.contacts.MyContacts
import `in`.kaligotla.allpermissions.presentation.main.permissions.extras.security.MyBiometrics
import `in`.kaligotla.allpermissions.presentation.main.permissions.location.MyLocation
import `in`.kaligotla.allpermissions.presentation.main.permissions.microphone.MyMicrophone
import `in`.kaligotla.allpermissions.presentation.main.permissions.musicAudio.MyMusicAudio
import `in`.kaligotla.allpermissions.presentation.main.permissions.nearbyDevices.MyNearbyDevices
import `in`.kaligotla.allpermissions.presentation.main.permissions.notifications.MyNotifications
import `in`.kaligotla.allpermissions.presentation.main.permissions.phone.MyPhone
import `in`.kaligotla.allpermissions.presentation.main.permissions.photosVideos.MyPhotosVideos
import `in`.kaligotla.allpermissions.presentation.main.permissions.physicalActivity.MyPhysicalActivity
import `in`.kaligotla.allpermissions.presentation.main.permissions.sms.MySms
import `in`.kaligotla.allpermissions.presentation.settings.SettingsScreen
