package `in`.kaligotla.allpermissions.presentation.main.permissions.calendar
...
import `in`.kaligotla.allpermissions.data.domain.model.entities.CalendarItem
import `in`.kaligotla.allpermissions.data.domain.model.entities.EventItem
