...
import `in`.kaligotla.allpermissions.presentation.common.LaunchItem
import `in`.kaligotla.allpermissions.presentation.main.mainCommon.MyObserver
...
fun MyHome(
    ...
    val observer = MyObserver(LocalContext.current, Handler(Looper.getMainLooper()))
